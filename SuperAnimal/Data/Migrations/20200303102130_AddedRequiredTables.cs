    ...
    public partial class AddedRequiredTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FatherPet", x => x.PetId);
                    table.ForeignKey(
                        name: "FK_FatherPet_Pets_UserId",
                        column: x => x.UserId,
                        principalTable: "Pets",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MotherPet", x => x.PetId);
                    table.ForeignKey(
                        name: "FK_MotherPet_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "PetId",
                        onDelete: ReferentialAction.Cascade);
